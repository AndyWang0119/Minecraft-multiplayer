...
### Ver. 2.3
- [工程师的装饰] engineersdecor
- [沉浸长杆] ImmersivePosts

### Ver. 2.4
- [机械动力：合金] alloyed
- [机械动力：喷气背包] create_jetpack
- [机械动力：奶茶店] createcafe
- [机械动力：实用物件] create_misc_and_things
- [机械动力：晶莹剔透] create_crystal_clear
- [机械动力：汽鸣铁道] Steam_Rails
- [机械动力：火炮] createbigcannons
- [机械动力：甜食] create-confectionery
- [机械动力：矿石开掘] createoreexcavation
- [机械动力：绝命毒师] createbb：已自行汉化
...
### Ver. 2.3
- [懒人厨房] cookingforblockheads：背包食材可做食物食谱和所有食谱

### Ver. 2.4
- [农夫乐事扩展] Delightful
- [农场贸易] farmingforblockheads
- [生活调味料：胡萝卜版] SoL-Carrot
...
### Ver. 2.2
- [更好的战斗] bettercombat
- <del> [cgm扩展] projectarsenal：之后再魔改配方 <del>
...
- <del> [耐久信息显示] durabilityviewer <del>
...
### Ver. 2.2
- ToolStats
- [可视性：重铸] Visuality：更多粒子效果
- [提示] Tips
- [更多动作] personality
- [Discord状态显示] simple-rpc
- [物理效果] physics-mod-pro
...
- [试验假人] dummmmmmy
- [边拿边走] InvMove
- [进度牌匾] AdvancementPlaques
- [阿卡什宝典] AkashicTome

### Ver. 2.4
- [键位冲突显示] Controlling
- [现代化 UI] ModernUI
- [JEI工作方块] JustEnoughProfessions
- [游戏菜单模组设定] GameMenuModOption
...
### Ver. 2.2
- [残暴与掠夺] savage_and_ravage
- [碧海新生] upgrade_aquatic
- [邪猎者] hunterillager
- [风滚草] Tumbleweed
...
- [经验机制改革] Clumps
- lightspeed：改善游戏加载速度
- <del> betterfpsdist：客户端无效 <del>
- [树叶渲染优化] cullleaves
- [实体渲染机制优化] entityculling
- <del> [铁氧体磁芯] ferritecore：降低内存消耗，但也降低帧数 <del>
- [FPS减速器] FpsReducer2
- [DFU载入优化] lazydfu
...
- [星光] starlight：光线优化
- [更好的铷视频设置按钮] BRVSB
- [镁／铷：附属] rubidium_extras

### Ver. 2.3
- Entity_Collision_FPS_Fix
- [预生成区块] Chunky
- [红石性能优化] alternate-current

### Ver. 2.4
- Fastload-Reforged：地图加载优化
- [工作台性能优化] FastWorkbench
- [熔炉性能优化] FastFurnace
- [配方性能优化] FastSuite
- canary
- servercore
